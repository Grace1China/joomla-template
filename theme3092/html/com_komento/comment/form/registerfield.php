...
if ( false ) {  //($system->config->get( 'enable_registration' ) && $system->my->guest) { ?>
	<div class="kmt-form-group">
		...
		<label id="register-checkbox-label" for="register-checkbox">
	...
	<div>
		<div>
			<input id="register-username" class="input" type="text" placeholder="<?php echo JText::_( 'COM_KOMENTO_FORM_USERNAME' ); ?>">
		</div>
	</div>
<?php }
