...
$print_facebook = '';
$print_facebook .= '<iframe src="http://www.facebook.com/plugins/likebox.php?href='.$pageURL.'&amp;width='.$width.'&amp;colorscheme='.$color_scheme.'&amp;show_faces='.$show_faces.'&amp;connections='.$connections.'&amp;stream='.$streams.'&amp;show_border='.$border.'&amp;header='.$header.'&amp;height='.$height.'" style="border:none; overflow:hidden; width:'.$width.'px; height: '.$height.'px;"></iframe>';
?>
